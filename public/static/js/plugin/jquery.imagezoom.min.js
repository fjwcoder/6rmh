(function($){$.fn.imagezoom=function(options){var settings={xzoom:544,yzoom:544,offset:0,position:"BTR",preload:1};if(options){$.extend(settings,options);}//xzoom: 大图展示框的宽 yzoom: 大图展示框的高
var noalt='';
var self=this;
