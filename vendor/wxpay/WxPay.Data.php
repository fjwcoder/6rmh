...
class WxPayDataBase
{
	...
	/****************************************威富通接口参数**************************************/
	/** add by fjw 2017.2.6 威富通
	* 设置威富通支付接口类型，pay.weixin.native
	* @param string $value 
	**/
	public function SetService($value){
		$this->values['service'] = $value?$value:'pay.weixin.native';
	}
	/**
	* 获取威富通支付接口类型
	* @return 值
	...
	* @param string $value 
	**/
	public function SetMch_create_ip($value){
	...
	* @return 值
	**/
	public function GetMch_create_ip()
	{
		return $this->values['mch_create_ip'];
	}
	/**
	* 判断威富通是否设置机器IP
	* @return true 或 false
	**/
	public function IsMch_create_ipSet()
	{
		return array_key_exists('mch_create_ip', $this->values);
	}
...
class WxPayResults extends WxPayDataBase
{
	...
	public function CheckSign()
	{
		//fix异常
		if(!$this->IsSignSet()){
			throw new WxPayException("没有设置签名！");
		}
...
{	
	...
	* @param string $value 
	**/
	public function SetIs_subscribe($value)
	{
		$this->values['is_subscribe'] = $value;
	}
	/**
	* 是否关注
	* @return 值
	...
	* @return true 或 false
	**/
	public function IsIs_subscribeSet()
	{
	...
	* @param string $value 
	**/
	public function SetJsapi_ticket($value)
	{
		$this->values['jsapi_ticket'] = $value;
	}
	/**
	* 调用js时的jsapi_ticket
	* @return 值
	**/
	...
	{
		return $this->values['jsapi_ticket'];
	}
	...
	* @return true 或 false
	**/
	public function IsJsapi_ticketSet()
	{
		return array_key_exists('jsapi_ticket', $this->values);
	}/**
	* 调用js时的jsapi_ticket
	* @param string $value 
	**/
	...
	**/
	...
	{
		return array_key_exists('url', $this->values);
	}
